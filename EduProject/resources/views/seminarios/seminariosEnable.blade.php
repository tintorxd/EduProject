                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea class="form-control" name="descripcion" placeholder="Breve descripcion del seminario"
                                        aria-label="Breve descripcion del seminario" aria-describedby="basic-icon-default-fullname2">{{ $seminario->descripcion }}
                              </textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                ...
                <div class="" style="max-with: 500px; padding-left: 10px;padding-right: 10px">
                    <div class="card mb-4">
                        <div class="row text-center">
                            <div>
                                <img src="{{ URL::asset('assets/img/userImage.png') }}" width="150px"
                                    height="150px">
                            </div>
                        </div>
                    </div>
